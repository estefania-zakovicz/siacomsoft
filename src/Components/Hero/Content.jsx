  ...
  return (
    <div className="absolute top-0 left-0 w-full flex items-center justify-center">
      <div className="w-full h-full flex flex-col lg:flex-row">
        <div className="flex flex-col mt-64 md:mt-64 lg:mt-28 lg:ml-36 px-4 lg:px-0 xl:mt-44">
          <motion.p
            initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.5, duration: 2 }}
            className="text-white text-5xl text-center lg:mt-32 lg:text-left lg:text-8xl font-semibold mb-2 w-full lg:w-3/4 md:text-7xl xl:mt-0 xl:text-8xl 2xl:mt-0"
          >
