...
const Carousel = () => {
  ...
  return (
    <section className="relative w-full h-screen flex items-center justify-center overflow-hidden bg-cover bg-center">
      {/* Fondo borroso con bordes redondeados */}
      <div className="absolute mx-20 my-10 inset-0 bg-gradient-to-r from-blue-200 via-blue-400 to-pink-400 rounded-3xl z-0"></div>
      <div className="flex items-center gap-5 z-10">
        
        {/* z-10 para poner encima del blur */}
